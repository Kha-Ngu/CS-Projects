...
int main() {
	...
	cout << "Expected:  0 " << (bool) (dur64 < dur66) << endl;
	cout << "Expected:  1 " << (bool) (dur64 > dur66) << endl;
	cout << "Expected:  1 " << (bool) (dur65 >= dur66) << endl;
	cout << "Expected:  1 " << (bool) (dur65 <= dur66) << endl;

    // Cin & CoutTest
	TimeSpan dur70;
	cout << "Enter time in the following format: hours minutes seconds" << endl;
	cin >> dur70;
	cout << dur70 << endl;
