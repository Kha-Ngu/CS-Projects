/**
 * This class inherits from Base and represents an Alfredo base
 * @author Khanh Nguyen
 * @version 12/7/23
 */
public class Alfredo extends Base{
     ...
     * @param description   The description of Alfredo base
     * @param cost  The cost of Alfredo base
     * @param calories  The calories count of Alfredo base
     */
    ...
    public static void main(String[] args) throws Exception {
        Alfredo i = new Alfredo("A1", new Money(1), 1);
        Alfredo i2 = new Alfredo("A2", new Money(2, 5), 2);

        if(!i.getDescription().equals("A1")) {
