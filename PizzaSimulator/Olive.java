...
/**
 * This class inherits from Vegetables and represents an olive
 * @author Khanh Nguyen
 * @version 12/7/23
 */
public class Olive extends Vegetable{
    /**
     * Constructor
     * @param description   Description of the olive
     * @param cost    Cost of the olive
     * @param cal   The calorie count of the olive
     */
    public Olive(String description, Money cost, int cal) {
     ...
     */
    public Olive(String description, Money cost, int cal, Color color) {
    ...
    public static void main(String[] args) throws Exception {
        Olive i = new Olive("O1", new Money(1), 1);
        Olive i2 = new Olive("O2", new Money(2, 5), 2);
        Vegetable i3 = new Vegetable("O3", new Money(12, 99), 80, Color.black);
